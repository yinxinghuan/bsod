#!/usr/bin/env python3
"""Generate Laisa full sprite set with Flux2 Klein (no LoRA)."""
...
def build_workflow(prompt, seed):
    return {
        ...
        "13": {"class_type": "SaveImage",
               "inputs": {"images": ["12", 0], "filename_prefix": "laisa_sprite"}},
    }
...
if __name__ == "__main__":
    try:
        ...
        print(f"ComfyUI v{v} — generating {len(SPRITES)} Laisa sprites\n")
