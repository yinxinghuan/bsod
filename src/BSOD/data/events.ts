    ...
    choices: [
      {
        ...
        resultZh: '弹幕爆笑，气氛变得轻松，大家更喜欢你了',
        resultEn: 'Chat erupts in laughter, the vibe lightens up and viewers love your attitude',
      ...
      },
      {
        ...
        resultZh: '你沉默地继续挑战，专注度提高了',
        resultEn: 'You silently push on. Your focus sharpens.',
      ...
      },
      {
        ...
        resultZh: '坦诚打动了一些人，但心情有点低落',
        resultEn: 'Your honesty resonates with some, but your mood dips a little',
    ...
    choices: [
      {
        ...
        resultZh: '弹幕欢呼，大家很开心你听取了意见',
        resultEn: 'Chat cheers — they love that you listened',
      ...
      },
      {
        ...
        resultZh: '一些人离开了，但你坚持了自己的节奏',
        resultEn: 'Some leave, but you stick to your pace and feel good about it',
      ...
      },
      {
        ...
        resultZh: '大家积极参与投票，互动感拉满',
        resultEn: 'Everyone joins in — the vote creates great engagement',
    ...
    choices: [
      {
        ...
        resultZh: '观众被你的坦诚打动，弹幕里满是温暖的话',
        resultEn: 'Viewers are moved by your honesty. Chat fills with warmth.',
      ...
      },
      {
        ...
        resultZh: '大家没多问，直播继续正常进行',
        resultEn: 'Nobody pushes further. The stream continues as normal.',
        effect: { followers: 40 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '假装开心让你更疲惫了……',
        resultEn: 'Forcing happiness drains you even more...',
    ...
    choices: [
      {
        ...
        resultZh: '新观众留下了，觉得你很亲切',
        resultEn: 'The new viewer stays — they think you\'re really welcoming',
      ...
      },
      {
        ...
        resultZh: '新人看了一会儿就走了，但你没受影响',
        resultEn: 'The newcomer watches for a bit and leaves. You don\'t mind.',
        effect: { followers: 60 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '观众耐心等待，你冷静地解决了问题',
        resultEn: 'Viewers wait patiently. You handle it calmly.',
      ...
      },
      {
        ...
        resultZh: '大量观众离开了，你的信心也跟着下降',
        resultEn: 'Viewers flood out. Your confidence drops with them.',
      ...
      },
      {
        ...
        resultZh: '大家觉得字幕模式反而很有趣',
        resultEn: 'Chat actually finds the subtitle mode pretty entertaining',
    ...
    choices: [
      {
        ...
        resultZh: '你真诚的回应让整个直播间安静了一刻，然后满屏爱心',
        resultEn: 'Your genuine response silences chat for a moment — then hearts fill the screen',
      ...
      },
      {
        ...
        resultZh: '简单的感谢，心里暖暖的',
        resultEn: 'A simple thank-you. It still warms you inside.',
    ...
    choices: [
      {
        ...
        resultZh: '弹幕热烈讨论起联动人选，气氛很嗨',
        resultEn: 'Chat goes wild debating who to collab with — great energy',
      ...
      },
      {
        ...
        resultZh: '有人觉得你太高冷离开了，但你保持了自己的风格',
        resultEn: 'Some think you\'re cold and leave, but you stay true to yourself',
    ...
    choices: [
      {
        ...
        resultZh: '你拼命挑战，弹幕疯狂刷礼物，但体力消耗不小',
        resultEn: 'You go all-in. Gifts pour in from chat, but it takes a toll on your energy.',
      ...
      },
      {
        ...
        resultZh: '你专注通关，观众被你的认真感染了',
        resultEn: 'You focus on clearing the level. Viewers respect the dedication.',
    ...
    choices: [
      {
        ...
        resultZh: '几个人回复了，气氛慢慢恢复',
        resultEn: 'A few people respond. The mood gradually picks back up.',
      ...
      },
      {
        ...
        resultZh: '你沉浸在游戏里，不在意弹幕',
        resultEn: 'You immerse yourself in the game, unbothered.',
        effect: { focus: 15 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '安静让你越来越焦虑，操作失误频频',
        resultEn: 'The silence feeds your anxiety. You start making mistakes.',
        effect: { mood: -12, focus: -8 },
        emotion: 'sad',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '温暖的时刻，大家一起庆祝这个小小里程碑',
        resultEn: 'A warm moment. Everyone celebrates this little milestone together.',
      ...
      },
      {
        ...
        resultZh: '你淡定地继续，心无旁骛',
        resultEn: 'You stay focused. Numbers don\'t define you.',
        effect: { focus: 10 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '慢速模式生效，恶意弹幕减少了，你保持了冷静',
        resultEn: 'Slow mode kicks in. The hate thins out. You keep your cool.',
      ...
      },
      {
        ...
        resultZh: '暂停后大量观众流失，你的心情也跌入谷底',
        resultEn: 'After pausing, viewers pour out. Your mood crashes.',
      ...
      },
      {
        ...
        resultZh: '真正的粉丝站出来帮你说话，反而更团结了',
        resultEn: 'Loyal fans step up to defend you. The community bonds tighter.',
    ...
    choices: [
      {
        ...
        resultZh: '你全力表演，新观众涌入，但精力消耗巨大',
        resultEn: 'You go all out. New viewers flood in, but it drains you hard.',
      ...
      },
      {
        ...
        resultZh: '平常心反而让你状态稳定，新观众慢慢留下',
        resultEn: 'Staying calm keeps you steady. New viewers stick around.',
    ...
    choices: [
      {
        ...
        resultZh: '弹幕疯狂夸作者，直播间氛围超棒',
        resultEn: 'Chat showers praise on the artist. The stream vibe is amazing.',
      ...
      },
      {
        ...
        resultZh: '你默默感谢了画者，心里暖暖的',
        resultEn: 'You quietly thank the artist. It feels warm inside.',
        effect: { mood: 15, followers: 80 },
        emotion: 'happy',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '你的真诚让观众感动落泪，这一刻会被记住很久',
        resultEn: 'Your sincerity moves viewers to tears. This moment will be remembered.',
      ...
      },
      {
        ...
        resultZh: '大家觉得你很可爱，虽然有点混乱',
        resultEn: 'Chat finds it adorable, even if a bit chaotic.',
    ...
    choices: [
      {
        ...
        resultZh: '画质降了但至少流畅了，观众表示理解',
        resultEn: 'Quality drops but at least it\'s smooth. Viewers understand.',
      ...
      },
      {
        ...
        resultZh: '画面越来越卡，观众纷纷离开……',
        resultEn: 'The lag gets worse. Viewers start leaving...',
      ...
      },
      {
        ...
        resultZh: '大家被你的幽默逗乐了，卡顿反而变成了名场面',
        resultEn: 'Your humor turns the lag into a highlight moment.',
    ...
    choices: [
      {
        ...
        resultZh: '热搜带来大波新观众，你趁势展示了自己',
        resultEn: 'The trending topic floods in new viewers. You seize the moment.',
      ...
      },
      {
        ...
        resultZh: '你保持低调，专注内容本身',
        resultEn: 'You stay low-key and focus on the content.',
    ...
    choices: [
      {
        ...
        resultZh: '大主播也打了招呼，弹幕沸腾了',
        resultEn: 'The big streamer greets you back. Chat goes absolutely wild.',
      ...
      },
      {
        ...
        resultZh: '你继续做自己的事，有人觉得你很酷',
        resultEn: 'You stay on your grind. Some think that\'s pretty cool.',
      ...
      },
      {
        ...
        resultZh: '你的操作变得混乱，一些人开始嘲笑……',
        resultEn: 'Your gameplay falls apart. Some start mocking...',
    ...
    choices: [
      {
        ...
        resultZh: '你趁热度转发，粉丝暴涨，这一刻属于你',
        resultEn: 'You share it and ride the wave. Followers surge. This is your moment.',
      ...
      },
      {
        ...
        resultZh: '你没特别在意，但播放量还是给你带来了不少新粉',
        resultEn: 'You don\'t make a fuss, but the views still bring new followers.',
    ...
    choices: [
      {
        ...
        resultZh: '你认真地说了自己的想法，弹幕里很多人说被触动了',
        resultEn: 'You speak from the heart. Many in chat say they\'re touched.',
      ...
      },
      {
        ...
        resultZh: '一键封禁，世界清静了',
        resultEn: 'One click, banned. Peace restored.',
        effect: { followers: 80, mood: 5 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '那句话一直在你脑海里回响……',
        resultEn: 'Those words keep echoing in your head...',
    ...
    choices: [
      {
        ...
        resultZh: '大家被你的幽默逗乐了，剧透者也不好意思了',
        resultEn: 'Chat laughs. Even the spoiler feels a bit sheepish.',
      ...
      },
      {
        ...
        resultZh: '弹幕安静了一下，之后大家更注意了',
        resultEn: 'Chat goes quiet for a moment. People are more careful after that.',
      ...
      },
      {
        ...
        resultZh: '你的沉默让气氛变得尴尬……',
        resultEn: 'Your silence makes things awkward...',
    ...
    choices: [
      {
        ...
        resultZh: '你的调停让两边都冷静下来了',
        resultEn: 'Your calm mediation de-escalates both sides.',
      ...
      },
      {
        ...
        resultZh: '一个段子把战火化为笑声，危机解除',
        resultEn: 'A well-timed joke turns the fight into laughter. Crisis averted.',
        effect: { followers: 140, mood: 10 },
        emotion: 'happy',
      },
      {
        ...
        resultZh: '有人觉得你处理太粗暴，气氛变得不好',
        resultEn: 'Some think your handling was too harsh. The mood sours.',
    ...
    choices: [
      {
        ...
        resultZh: '摄像头打开的瞬间弹幕炸了，大家疯狂截图',
        resultEn: 'The moment the cam turns on, chat explodes. Everyone screenshots.',
        effect: { followers: 320, mood: 15 },
        emotion: 'happy',
      },
      {
        ...
        resultZh: '大家理解了你的想法，尊重你的选择',
        resultEn: 'Viewers understand and respect your choice.',
      ...
      },
      {
        ...
        resultZh: '拒绝后弹幕有些失望，你也觉得有点不舒服',
        resultEn: 'Chat is a bit disappointed. You feel a bit off too.',
        effect: { followers: -120, mood: -10 },
        emotion: 'sad',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '弹幕全在庆祝，这一刻太棒了！',
        resultEn: 'Chat celebrates with you. What an amazing moment!',
      ...
      },
      {
        ...
        resultZh: '你的谦虚让大家觉得你很真实',
        resultEn: 'Your humility makes you feel genuine to viewers.',
    ...
    choices: [
      {
        ...
        resultZh: '大家表示理解，约好断了就明天再见',
        resultEn: 'Viewers are understanding — if it cuts, they\'ll see you tomorrow.',
      ...
      },
      {
        ...
        resultZh: '你心里有点忐忑，但直播还在继续',
        resultEn: 'A bit anxious, but the stream goes on.',
    ...
    choices: [
      {
        ...
        resultZh: '你陪他聊了很久，他说感觉好多了。你也累了，但心里温暖',
        resultEn: 'You talk with them for a while. They feel better. You\'re tired, but warm inside.',
      ...
      },
      {
        ...
        resultZh: '他说好，你继续直播，心里记着这件事',
        resultEn: 'They say okay. You continue streaming, keeping it in mind.',
        effect: { followers: 60, mood: 5, connection: 1 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '你什么也没说，对方也没再回复……你觉得很愧疚',
        resultEn: 'You say nothing. They don\'t reply again. Guilt lingers.',
        effect: { mood: -15, followers: -80 },
        emotion: 'sad',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '你的大度赢得了尊重，弹幕里满是支持',
        resultEn: 'Your grace earns respect. Chat fills with support.',
      ...
      },
      {
        ...
        resultZh: '你暗自发力，专注度拉满，但心里有点不舒服',
        resultEn: 'You channel it into focus. Determined, but it stings a little.',
      ...
      },
      {
        ...
        resultZh: '比较的压力让你完全失去节奏……',
        resultEn: 'The comparison crushes you. You lose all momentum...',
    ...
    choices: [
      {
        ...
        resultZh: '对方特别开心，你也因此感到温暖',
        resultEn: 'They\'re so happy. It warms your heart too.',
      ...
      },
      {
        ...
        resultZh: '对方理解了，你继续忙自己的',
        resultEn: 'They understand. You get back to your own thing.',
      ...
      },
      {
        ...
        resultZh: '你完全忘了这件事……事后想起来有点内疚',
        resultEn: 'You totally forget... Guilt hits when you remember later.',
    ...
    choices: [
      {
        ...
        resultZh: '海外观众们很激动，弹幕变成了多语言派对',
        resultEn: 'The international viewers are thrilled. Chat becomes a multilingual party.',
      ...
      },
      {
        ...
        resultZh: '语言不通也没关系，有些人因为你的风格留下了',
        resultEn: 'Language barrier or not, some stay for your style.',
        effect: { followers: 120, focus: 8 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '大家冲进小主播的直播间，对方开心得语无伦次',
        resultEn: 'Everyone floods the small streamer\'s chat. They\'re speechless with joy.',
      ...
      },
      {
        ...
        resultZh: '你安静地结束了直播',
        resultEn: 'You end the stream quietly.',
        effect: { followers: 0 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '你的真实让大家更喜欢你了，弹幕满屏加油',
        resultEn: 'Your authenticity wins them over. Chat fills with encouragement.',
      ...
      },
      {
        ...
        resultZh: '你匆匆跳过，但心里留下了一丝不安',
        resultEn: 'You brush past it, but something lingers.',
        effect: { mood: -8, followers: 80 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '你的慌张被观众捕捉到了，气氛变得微妙',
        resultEn: 'Viewers pick up on your panic. The vibe shifts.',
    ...
    choices: [
      {
        ...
        resultZh: '你的笑声感染了所有人，弹幕变成一片笑声',
        resultEn: 'Your laughter is contagious. Chat erupts in joy.',
      ...
      },
      {
        ...
        resultZh: '你深吸一口气，重新开始。专注而坚定',
        resultEn: 'You take a deep breath and restart. Focused and determined.',
      ...
      },
      {
        ...
        resultZh: '你的脆弱反而让人感到真实，有人发了一堆安慰的话',
        resultEn: 'Your vulnerability feels real. Comforting messages pour in.',
    ...
    choices: [
      {
        ...
        resultZh: '大家在弹幕里争着回答，气氛超级热烈！',
        resultEn: 'Everyone talks over each other answering. The energy is electric!',
      ...
      },
      {
        ...
        resultZh: '你保持了冷静，新观众觉得你很从容',
        resultEn: 'You stay composed. The new viewers think you\'re cool.',
    ...
    choices: [
      {
        ...
        resultZh: '你很期待成品，这也是一种被认可的感觉',
        resultEn: 'You\'re excited to see the result. It feels like recognition.',
      ...
      },
      {
        ...
        resultZh: '你谨慎地了解了对方，做了个明智的决定',
        resultEn: 'You carefully vet them. A wise decision.',
      ...
      },
      {
        ...
        resultZh: '你选择保护自己的内容，对方表示理解',
        resultEn: 'You protect your content. They understand.',
        effect: { mood: 5, focus: 10 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '弹幕为你开心，第一个商务合作！',
        resultEn: 'Chat celebrates with you. Your first brand deal!',
      ...
      },
      {
        ...
        resultZh: '你冷静地评估，这才是专业做法',
        resultEn: 'You evaluate calmly. That\'s the professional move.',
      ...
      },
      {
        ...
        resultZh: '你选择保持纯粹，粉丝更尊重你了',
        resultEn: 'You keep it pure. Fans respect you even more.',
    ...
    choices: [
      {
        ...
        resultZh: '你迅速处理了危机，避免了封号风险',
        resultEn: 'You handle the crisis swiftly, avoiding a ban.',
        effect: { followers: -80, mood: -5, focus: 10 },
        emotion: 'normal',
      },
      {
        ...
        resultZh: '直播被静音了一段时间，观众纷纷离开……',
        resultEn: 'The stream gets muted. Viewers start leaving...',
      ...
      },
      {
        ...
        resultZh: '你坦率地聊了版权的话题，大家觉得很有收获',
        resultEn: 'You chat openly about copyright. Viewers find it informative.',
        effect: { followers: 60, mood: 5, connection: 1 },
        emotion: 'normal',
      },
    ],
    ...
    choices: [
      {
        ...
        resultZh: '你结结巴巴地说了名字和兴趣，有人打了个"你好"',
        resultEn: 'You stumble through your name and interests. Someone types "hello".',
        effect: { mood: 8, followers: 30 },
      },
      {
        labelZh: '直接开始打游戏',
        labelEn: 'Just start playing',
        resultZh: '你默默地打开了游戏，画面说明一切',
        resultEn: 'You silently launch the game. The gameplay does the talking.',
    ...
    choices: [
      {
        ...
        resultZh: '弹幕回复："加油！我们陪着你"',
        resultEn: 'Chat replies: "You got this! We\'re here for you"',
      ...
      },
      {
        ...
        resultZh: '没人追问，你松了口气',
        resultEn: 'Nobody pushes. You breathe a sigh of relief.',
    ...
    choices: [
      {
        ...
        resultZh: '你多陪了大家一局，虽然累了但觉得值得',
        resultEn: 'You stay for one more. Tired, but worth it.',
        effect: { followers: 55, energy: -10 },
      },
      {
        labelZh: '好，明天见',
        labelEn: 'Alright, see you tomorrow',
        resultZh: '"明天见"——简单的约定，但让你有点期待',
        resultEn: '"See you tomorrow" — a simple promise that gives you something to look forward to.',
