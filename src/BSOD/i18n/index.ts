const translations = {
  zh: {
    ...
    'ending.online.text': '你在一个不可能赢的游戏里赢了。不只是数字——有些人知道你叫 Isaya，不只是某个主播。',
  ...
  en: {
    ...
    'ending.online.text': 'You won in a game that wasn\'t supposed to be winnable. Not just the numbers — some people know your name is Isaya, not just "some streamer".',
